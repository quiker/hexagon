...
public class Game : MonoBehaviour {
	...
	private void ActivatePanel(string panel)
	{
		...
		if (scoreTablePanel != null) scoreTablePanel.SetActive(false);
		if (settingsPanel != null) settingsPanel.SetActive(false);
		if (completePanel != null) completePanel.SetActive(false);
		if (failPanel != null) failPanel.SetActive(false);
		switch (panel)
		{
			case "mainMenu":    mainMenuPanel.SetActive(true); break;
			case "pause":       pauseMenu.show();  break;
			case "selectLevel": selectLevelPanel.SetActive(true); break;
			case "tutorial":    tutorialPanel.SetActive(true); break;
			case "scoreTable":  scoreTablePanel.SetActive(true); break;
			case "settings":    settingsPanel.SetActive(true); break;
			case "complete":    completePanel.SetActive(true); break;
			case "fail":        failPanel.SetActive(true); break;
		}
	}
